...
namespace FrontendWpf
{
    ...
    public partial class MainWindow
    {
        public MainWindow()
        {
            ...
            _logger = new WpfConsoleLogger(ref LogTextBlock);
        }

        private readonly WpfConsoleLogger _logger;
        ...
        private void SaveLogFileButton_OnClick(object sender, RoutedEventArgs e)
        {
            ...
            if (saveDialog.ShowDialog() == true)
            {
                try
                {
                    _logger.SaveToFile(saveDialog.FileName);
        ...
        private void ConvertKeysButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                _logger.Error(string.Format("Exception caught while attempting to convert files: {0}. Stacktrace: {1}", ex.Message, ex.StackTrace));
                ConversionResultTextBox.Inlines.Clear();
