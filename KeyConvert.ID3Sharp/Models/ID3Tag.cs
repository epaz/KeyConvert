...
namespace ID3Sharp.Models
{
	...
	public abstract class ID3Tag
	{
        ...
        /// <summary>
        /// Gets and sets the key of the file this tag represents.
        /// </summary>
        ...
        /// <summary>
        /// Gets a value indicating whether the Key property is not empty or null.
        /// </summary>
	    public bool HasKey
	    {
	        get
	    ...
	    public abstract string UniqueFileIdentifier { get; set; }
