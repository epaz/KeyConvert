...
namespace ID3Sharp.Models
{
	...
	public class ID3v2Tag : ID3Tag
	{
        ...
        /// <summary>
        /// Gets or sets the value of the key frame.
        /// </summary>
	    public override string Key
	    {
	        get { return GetFrameTextValue(FrameType.InitialKey); }

	        set
	        {
	            SetFrameTextValue(FrameType.InitialKey, value);
	        }
	    }
        ...
        /// TODO
        /// </summary>
	    public override string UniqueFileIdentifier
	    {
            get { return GetFrameTextValue(FrameType.UniqueFileIdentifier); }

            set
            {
                SetFrameTextValue(FrameType.UniqueFileIdentifier, value);
            }
	    }
